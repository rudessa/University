...
def register_device(device: DeviceRegistration, tasks: BackgroundTasks):
    ...
    # Send notification to both admin and device owner
    tasks.add_task(send_telegram_notification, message, extra_chat_ids=owner_chat_ids)
